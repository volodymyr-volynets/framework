...
class HTML
{
     ...
     * White space tags
     */
    public const HTML_WHITE_SPACE_TAGS_ARRAY = ['<br>', '<br/>', '<br />', '<hr>', '<hr/>', '<hr />'];
     ...
     * @return string
     */
    public static function pre(array $options = []): string
    {
        return Factory::delegate('flag.numbers.framework.html', 'pre', [$options]);
    }
