...
$temp = file_get_contents($install_dir . '/code/application/config/application.ini.default');
$temp = str_replace('[numbers_framework_version]', $params['version'], $temp);
file_put_contents($install_dir . '/code/application/config/application.ini', $temp);
shell_exec("rm $install_dir/code/application/config/application.ini.default");

// renaming localhost.ini file
shell_exec("mv $install_dir/code/application/config/localhost.ini.default $install_dir/code/application/config/localhost.ini");
