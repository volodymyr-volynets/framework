...
class Domains extends Data
{
    ...
    public $columns = [
        'code' => ['name' => 'Code', 'domain' => 'lgroup_code'],
    ...
    public $data = [
        ...
        'placeholder' => ['name' => 'Placeholder', 'type' => 'varchar', 'length' => 255, 'placeholder' => 'Placeholder'],
        'mention' => ['name' => 'Mention', 'type' => 'varchar', 'length' => 120, 'placeholder' => '@Mention', 'validator_method' => '\Object\Validator\Mention::validate'],
        'hash_tagged'  => ['name' => 'Hash Tagged', 'type' => 'varchar', 'length' => 120, 'placeholder' => '#Hash Tagged', 'validator_method' => '\Object\Validator\HashTagged::validate'],
        ...
        'content' => ['name' => 'Content', 'type' => 'text', 'placeholder' => 'Content'],
        'query' => ['name' => 'Query', 'type' => 'text', 'placeholder' => 'Query'],
        ...
        'keywords_text' => ['name' => 'Keywords (Text)', 'type' => 'text', 'placeholder' => 'Keywords'],
        'url' => ['name' => 'Url', 'type' => 'text', 'placeholder' => 'URL'],
        // codes
        'uuid' => ['name' => 'UUID', 'type' => 'char', 'length' => 36, 'uuid' => 1],
        'code' => ['name' => 'Code', 'type' => 'varchar', 'length' => 255],
        'code_az09' => ['name' => 'Code', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\AZ09::validate'],
        'slug' => ['name' => 'Slug', 'type' => 'varchar', 'length' => 255],
        'model' => ['name' => 'Model', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\Model::validate', 'placeholder' => 'Model'],
        'method' => ['name' => 'Method', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\Method::validate', 'placeholder' => 'Method'],
        'command' => ['name' => 'Command', 'type' => 'varchar', 'length' => 2000],
        'loc' => ['name' => 'Loc', 'type' => 'varchar', 'length' => 2000, 'validator_method' => '\Object\Validator\Loc::validate'],
        'access_key' => ['name' => 'Access Key', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\AccessKey::validate'],
        'long_code' => ['name' => 'Code (Long)', 'type' => 'varchar', 'length' => 5000, 'placeholder' => 'Code'],
        // upper-case codes
        ...
        'big_code' => ['name' => 'Big Code', 'type' => 'varchar', 'length' => 120, 'validator_method' => '\Object\Validator\UpperCase::validate'],
        'code255' => ['name' => 'Code (255)', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\UpperCase::validate'],
        'types' => ['name' => 'Types', 'type' => 'varchar', 'length' => 2000],
        // lower-case codes
        'lcode' => ['name' => 'Code', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\LowerCase::validate'],
        'lshort_code' => ['name' => 'Short Code', 'type' => 'varchar', 'length' => 6, 'validator_method' => '\Object\Validator\LowerCase::validate'],
        'ltype_code' => ['name' => 'Type Code', 'type' => 'varchar', 'length' => 15, 'validator_method' => '\Object\Validator\LowerCase::validate', 'placeholder' => 'Type'],
        'lgroup_code' => ['name' => 'Group Code', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\LowerCase::validate'],
        'lbig_code' => ['name' => 'Big Code', 'type' => 'varchar', 'length' => 120, 'validator_method' => '\Object\Validator\LowerCase::validate'],
        'ldomain' => ['name' => 'Domain', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\LowerCase::validate'],
        'ltype' => ['name' => 'Type', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\LowerCase::validate'],
        // pascal case codes
        'pccode' => ['name' => 'Code', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\PascalCase::validate'],
        'pcshort_code' => ['name' => 'Short Code', 'type' => 'varchar', 'length' => 6, 'validator_method' => '\Object\Validator\PascalCase::validate'],
        'pctype_code' => ['name' => 'Type Code', 'type' => 'varchar', 'length' => 15, 'validator_method' => '\Object\Validator\PascalCase::validate', 'placeholder' => 'Type'],
        'pcgroup_code' => ['name' => 'Group Code', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\PascalCase::validate'],
        'pcbig_code' => ['name' => 'Big Code', 'type' => 'varchar', 'length' => 120, 'validator_method' => '\Object\Validator\PascalCase::validate'],
        'pcdomain' => ['name' => 'Domain', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\PascalCase::validate'],
        'pctype' => ['name' => 'Type', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\PascalCase::validate'],
        // tokens & hash
        'hash' => ['name' => 'Hash', 'type' => 'varchar', 'length' => 64, 'placeholder' => 'Hash'],
        ...
        'status_code' => ['name' => 'Status Code', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\UpperCase::validate'],
        ...
        'column_name' => ['name' => 'Column Name', 'type' => 'varchar', 'length' => 60, 'placeholder' => 'Column'],
        'website' => ['name' => 'Website', 'type' => 'varchar', 'length' => 255, 'placeholder' => 'Website'],
        // types & groups
        ...
        'plan_id' => ['name' => 'Plan #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Plan'],
        'plan_id_sequence' => ['name' => 'Plan #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'trial_id' => ['name' => 'Trial #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Trial'],
        'trial_id_sequence' => ['name' => 'Trial #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'code_order' => ['name' => 'Order (Code)', 'type' => 'varchar', 'length' => 5000, 'placeholder' => 'Order'],
        'counter' => ['name' => 'Counter', 'type' => 'integer', 'default' => 0, 'format' => 'id'],
        'bigcounter' => ['name' => 'Counter (Big)', 'type' => 'bigint', 'default' => 0, 'format' => 'id'],
        'float_counter' => ['name' => 'Counter (Float)', 'type' => 'bcnumeric', 'precision' => 24, 'scale' => 2, 'default' => 0, 'format' => 'id', 'placeholder' => 'Counter', 'default' => '0.00', 'format' => 'number', 'align' => 'right'],
        'audience_id' => ['name' => 'Audience #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Audience'],
        'audience_id_sequence' => ['name' => 'Audience #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'segment_id' => ['name' => 'Segment #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Segment'],
        'segment_id_sequence' => ['name' => 'Segment #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'campaign_id' => ['name' => 'Campaign #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Campaign'],
        'campaign_id_sequence' => ['name' => 'Campaign #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'sender_id' => ['name' => 'Sender #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Sender'],
        'sender_id_sequence' => ['name' => 'Sender #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'layout_id' => ['name' => 'Layout #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Layout'],
        'layout_id_sequence' => ['name' => 'Layout #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'layout_code' => ['name' => 'Layout Code', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\UpperCase::validate'],
        // date & time
        ...
        'subject' => ['name' => 'Subject', 'type' => 'varchar', 'length' => 255, 'null' => true, 'placeholder' => 'Subject'],
        ...
        'whatsapp' => ['name' => 'WhatsApp', 'type' => 'varchar', 'length' => 50, 'validator_method' => '\Object\Validator\WhatsApp::validate', 'null' => true],
        ...
        'emoji' => ['name' => 'Emoji', 'type' => 'varchar', 'length' => 50, 'placeholder' => 'Emoji', 'null' => true],
        ...
        'email_phone_username' => ['name' => 'Username, Email Address or Phone', 'type' => 'varchar', 'length' => 255, 'validator_method' => '\Object\Validator\EmailPhoneUsername::validate', 'null' => true],
        'password_input' => ['name' => 'Password', 'type' => 'text'],
        'encrypted_password' => ['name' => 'Password (Encrypted)', 'type' => 'bytea'],
        'totp_secret' => ['name' => 'Secret (TOTP)', 'type' => 'text'],
        'ip' => ['name' => 'IP', 'type' => 'varchar', 'length' => 46, 'validator_method' => '\Object\Validator\IP::validate'],
        'host' => ['name' => 'Host', 'type' => 'varchar', 'length' => 255, 'placeholder' => 'Host', 'validator_method' => '\Object\Validator\Host::validate'],
        'host2' => ['name' => 'Host', 'type' => 'varchar', 'length' => 255, 'placeholder' => 'Host'],
        'port' => ['name' => 'Port', 'type' => 'integer', 'placeholder' => 'Port'],
        'user_agent' => ['name' => 'User Agent', 'type' => 'varchar', 'length' => 5000, 'placeholder' => 'User Agent'],
        'domain_part' => ['name' => 'Domain Part', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\Domain\Part::validate'],
        'database' => ['name' => 'Database', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\LowerCase::validate'],
        'table' => ['name' => 'Table', 'type' => 'varchar', 'length' => 63, 'validator_method' => '\Object\Validator\LowerCase::validate', 'null' => true],
        'mfa_code' => ['name' => 'MFA Code', 'type' => 'varchar', 'length' => 6, 'placeholder' => '6 Digit Code'],
        'mfa_code_extended' => ['name' => 'MFA Code (Extended)', 'type' => 'varchar', 'length' => 60, 'placeholder' => 'MFA Code'],
        'expires_seconds' => ['name' => 'Expires (Seconds)', 'type' => 'bigint', 'format' => 'id', 'placeholder' => 'Expires (Seconds)'],
        'expires_timestamp' => ['name' => 'Expires (Timestamp)', 'type' => 'bigint', 'format' => 'id', 'placeholder' => 'Expires (Timestamp)'],
        // system
        ...
        'module_code_extended' => ['name' => 'Module Code (Extended)', 'type' => 'varchar', 'length' => 5, 'validator_method' => '\Object\Validator\UpperCase::validate', 'placeholder' => 'Module'],
        'module_code_external' => ['name' => 'Module Code (External)', 'type' => 'char', 'length' => 3, 'decorators' => '\Object\Decorator\NoWhiteSpace::decorate', 'validator_method' => '\Object\Validator\UpperCase::validate', 'placeholder' => 'Module'],
        ...
        'action_id_sequence' => ['name' => 'Action #', 'type' => 'smallserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'preset_id' => ['name' => 'Preset #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Preset', 'searchable' => true],
        'preset_id_sequence' => ['name' => 'Preset #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'page_code' => ['name' => 'Page Code', 'type' => 'varchar', 'length' => 255, 'placeholder' => 'Page Code'],
        ...
        'folder_path' => ['name' => 'Folder (Path)', 'type' => 'text', 'null' => true],
        ...
        // user management
        'invite_id' => ['name' => 'Invite #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Invite', 'format' => 'id', 'searchable' => true],
        'invite_id_sequence' => ['name' => 'Invite #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id', 'searchable' => true],
        ...
        'realm_id' => ['name' => 'Realm #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Realm'],
        'realm_id_sequence' => ['name' => 'Realm #', 'type' => 'serial', 'placeholder' => 'Sequence'],
        'domain_id' => ['name' => 'Domain #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Domain'],
        'domain_id_sequence' => ['name' => 'Domain #', 'type' => 'serial', 'placeholder' => 'Sequence'],
        ...
        'reaction_id' => ['name' => 'Reaction #', 'type' => 'bigint', 'default' => null, 'format' => 'id'],
        'reaction_id_sequence' => ['name' => 'Reaction #', 'type' => 'bigserial', 'placeholder' => 'Sequence'],
        'weight' => ['name' => 'Weight', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Weight'],
        ...
        'chat_id' => ['name' => 'Chat #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Chat #'],
        'chat_id_sequence' => ['name' => 'Chat #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'department_id' => ['name' => 'Department #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Department'],
        ...
        'cell_size' => ['name' => 'Size (Cell)', 'type' => 'smallint', 'format' => 'id', 'placeholder' => 'Size'],
        // order management
        ...
        // document management
        'file_id' => ['name' => 'File #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'File', 'format' => 'id'],
        ...
        'file_dimensions' => ['name' => 'File Dimensions', 'type' => 'varchar', 'length' => 120, 'validator_method' => '\Object\Validator\Dimensions::validate'],
        'link_id' => ['name' => 'Link #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Link', 'format' => 'id'],
        'link_id_sequence' => ['name' => 'Link #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'text_id' => ['name' => 'Text #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Text', 'format' => 'id'],
        'text_id_sequence' => ['name' => 'Text #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        // communication
        ...
        'header_id' => ['name' => 'Header #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Header'],
        'header_id_sequence' => ['name' => 'Header #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'bigterm_id' => ['name' => 'Term #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Term'],
        'bigterm_id_sequence' => ['name' => 'Term #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        // project management
        ...
        'project_id' => ['name' => 'Project #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Project', 'format' => 'id'],
        'project_id_sequence' => ['name' => 'Project #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'project_code' => ['name' => 'Project Code', 'type' => 'varchar', 'length' => 255, 'placeholder' => 'Project Code'],
        'tracker_id' => ['name' => 'Tracker #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Tracker', 'format' => 'id'],
        'tracker_id_sequence' => ['name' => 'Tracker #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'wbs_id' => ['name' => 'WBS #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'WBS', 'format' => 'id'],
        'wbs_id_sequence' => ['name' => 'WBS #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'wbs_activity_id' => ['name' => 'WBS Activity #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'WBS', 'format' => 'id'],
        'wbs_activity_id_sequence' => ['name' => 'WBS Activity #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'issue_id' => ['name' => 'Issue #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Issue', 'format' => 'id'],
        'issue_id_sequence' => ['name' => 'Issue #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'problem_id' => ['name' => 'Problem #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Problem', 'format' => 'id'],
        'problem_id_sequence' => ['name' => 'Problem #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'matter_id' => ['name' => 'Matter #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Matter', 'format' => 'id'],
        'matter_id_sequence' => ['name' => 'Matter #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'requirement_id' => ['name' => 'Requirement #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Requirement', 'format' => 'id'],
        'requirement_id_sequence' => ['name' => 'Requirement #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'todo_id' => ['name' => 'TODO #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'TODO', 'format' => 'id'],
        'todo_id_sequence' => ['name' => 'TODO #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'test_id' => ['name' => 'Test #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Test', 'format' => 'id'],
        'test_id_sequence' => ['name' => 'Test #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'kanban_id' => ['name' => 'Kanban #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Kanban', 'format' => 'id'],
        'kanban_id_sequence' => ['name' => 'Kanban #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'calendar_id' => ['name' => 'Calendar #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Calendar', 'format' => 'id'],
        ...
        // support
        'tour_id' => ['name' => 'Tour #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Tour', 'format' => 'id'],
        'tour_id_sequence' => ['name' => 'Tour #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'ticket_id' => ['name' => 'Ticket #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Tour', 'format' => 'id'],
        'ticket_id_sequence' => ['name' => 'Ticket #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        // services
        ...
        'percent_float8' => ['name' => 'Percent (Float)', 'type' => 'bcnumeric', 'precision' => 24, 'scale' => 8, 'default' => 0, 'format' => 'id', 'placeholder' => 'Percent (%)', 'default' => '0.00000000', 'format' => 'number', 'align' => 'right'],
        ...
        'price_list_id' => ['name' => 'Price List #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Price List'],
        'price_list_id_sequence' => ['name' => 'Price List #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'detail_id' => ['name' => 'Detail #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Detail'],
        ...
        'batch_code' => ['name' => 'Batch Code', 'type' => 'varchar', 'length' => 120],
        ...
        'class_id' => ['name' => 'Class #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Class'],
        'class_id_sequence' => ['name' => 'Class #', 'type' => 'serial', 'format' => 'id', 'placeholder' => 'Sequence'],
        // ecommerce
        'item_id' => ['name' => 'Item #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Item'],
        'item_id_sequence' => ['name' => 'Item #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'catalog_id' => ['name' => 'Catalog #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Catalog'],
        'catalog_id_sequence' => ['name' => 'Catalog #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'option_id' => ['name' => 'Option #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Option'],
        'option_id_sequence' => ['name' => 'Option #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'merchant_id' => ['name' => 'Merchant #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Merchant'],
        'merchant_id_sequence' => ['name' => 'Merchant #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'profile_id' => ['name' => 'Profile #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Profile'],
        'profile_id_sequence' => ['name' => 'Profile #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'customer_profile_json' => ['name' => 'Customer Profile Json', 'type' => 'json', 'default' => null, 'null' => true],
        'credit_card_number' => ['name' => 'Credit Card Number', 'type' => 'varchar', 'length' => 30, 'default' => null, 'format' => 'id', 'placeholder' => 'Credit Card Number'],
        'credit_card_cvv' => ['name' => 'Credit Card CVV', 'type' => 'varchar', 'length' => 5, 'default' => null, 'format' => 'id', 'placeholder' => '###'],
        'calculation_id' => ['name' => 'Calculation #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Calculation'],
        'calculation_id_sequence' => ['name' => 'Calculation #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'charge_id' => ['name' => 'Charge #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Charge'],
        'charge_id_sequence' => ['name' => 'Charge #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'event_id' => ['name' => 'Event #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Event'],
        'event_id_sequence' => ['name' => 'Event #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        // games
        'game_id' => ['name' => 'Game #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Game', 'format' => 'id'],
        'game_id_sequence' => ['name' => 'Game #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        // HTML
        'html_color_code' => ['name' => 'HTML Color Code', 'type' => 'char', 'length' => 6, 'null' => true],
        'html_color_hash' => ['name' => 'HTML Color Hash', 'type' => 'char', 'length' => 7, 'null' => true],
        'html_color_group' => ['name' => 'HTML Color Group', 'type' => 'varchar', 'length' => 30, 'null' => true],
        'html_avatar_colors' => ['name' => 'HTML Avatar Colors', 'type' => 'varchar', 'length' => 120, 'null' => true],
        'html_tag_name' => ['name' => 'Tag Name', 'type' => 'varchar', 'length' => 120, 'placeholder' => 'Tag'],
        'html_tag_attribute_name' => ['name' => 'Tag Attribute Name', 'type' => 'varchar', 'length' => 255, 'placeholder' => 'Attribute'],
        'html_tag_attributes' => ['name' => 'Tag Attributes', 'type' => 'json', 'default' => null, 'null' => true],
        'html_css_styles' => ['name' => 'Style(s)', 'type' => 'text', 'placeholder' => 'CSS Styles', 'null' => true],
        'html_content' => ['name' => 'HTML Content', 'type' => 'text', 'placeholder' => 'HTML Content', 'null' => true],
        // printing
        'font_size' => ['name' => 'Font Size', 'type' => 'integer', 'default' => 8, 'format' => 'id'],
        'font_family' => ['name' => 'Font Family', 'type' => 'varchar', 'length' => 30, 'null' => true],
        'font_style' => ['name' => 'Font Style', 'type' => 'varchar', 'length' => 30, 'null' => true],
        'print_orientation' => ['name' => 'Print Orientation', 'type' => 'varchar', 'length' => 30, 'null' => true],
        'print_format' => ['name' => 'Print Format', 'type' => 'varchar', 'length' => 30, 'null' => true],
        // PII
        'age' => ['name' => 'Age', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Age'],
        'age_counter' => ['name' => 'Age (Float)', 'type' => 'bcnumeric', 'precision' => 24, 'scale' => 2, 'default' => 0, 'format' => 'id', 'placeholder' => 'Age (Float)', 'default' => null, 'format' => 'number', 'align' => 'right'],
        'sin' => ['name' => 'SIN', 'type' => 'varchar', 'length' => 120, 'null' => true, 'placeholder' => 'SIN'],
        // cron / tasks
        'cron_expression' => ['name' => 'Cron Expression', 'type' => 'varchar', 'length' => 255, 'null' => true],
        // credentials
        'key_id' => ['name' => 'Key #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Key'],
        'key_id_sequence' => ['name' => 'Key #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'vault_id' => ['name' => 'Vault #', 'type' => 'integer', 'default' => null, 'format' => 'id', 'placeholder' => 'Vault'],
        'vault_id_sequence' => ['name' => 'Vault #', 'type' => 'serial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'keypair_id' => ['name' => 'Key Pair #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Key Pair'],
        'keypair_id_sequence' => ['name' => 'Key Pair #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'encrypted_with_key' => ['name' => 'Encrypted (With Key)', 'type' => 'bytea'],
        'environment_variable_id' => ['name' => 'Environment Variable #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Environment Variable'],
        'environment_variable_id_sequence' => ['name' => 'Environment Variable #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        ...
        'bookmark_id' => ['name' => 'Bookmark #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Bookmark', 'format' => 'id'],
        'bookmark_id_sequence' => ['name' => 'Bookmark #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'secure_note_id' => ['name' => 'Secure Note #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Secure Note', 'format' => 'id'],
        'secure_note_id_sequence' => ['name' => 'Secure Note #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'identity_contact_id' => ['name' => 'Identity/Contact #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Identity/Contact', 'format' => 'id'],
        'identity_contact_id_sequence' => ['name' => 'Identity/Contact #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'mfa_id' => ['name' => 'MFA #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'MFA', 'format' => 'id'],
        'mfa_id_sequence' => ['name' => 'MFA #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'credit_card_id' => ['name' => 'Credit Card #', 'type' => 'bigint', 'default' => null, 'placeholder' => 'Credit Card', 'format' => 'id'],
        'credit_card_id_sequence' => ['name' => 'Credit Card #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        // credit cards
        'regexp' => ['name' => 'Regular Expression', 'type' => 'varchar', 'length' => 5000, 'placeholder' => 'Regular Expression'],
        'cc_code' => ['name' => 'Credit Card Type', 'type' => 'varchar', 'length' => 30, 'validator_method' => '\Object\Validator\UpperCase::validate'],
        'cc_expiration_month' => ['name' => 'Expiration Month', 'type' => 'smallint', 'format' => 'id', 'placeholder' => 'MM'],
        'cc_expiration_2digit' => ['name' => 'Expiration Month (2-digit)', 'type' => 'char', 'length' => 2, 'format' => 'id', 'placeholder' => 'MM'],
        'cc_expiration_year' => ['name' => 'Expiration Year', 'type' => 'smallint', 'format' => 'id', 'placeholder' => 'YYYY'],
        'cc_expiration_4digit' => ['name' => 'Expiration Year (4-digit)', 'type' => 'char', 'length' => 4, 'format' => 'id', 'placeholder' => 'YYYY'],
        // Feedback
        'feedback_id' => ['name' => 'Feedback #', 'type' => 'bigint', 'default' => null, 'format' => 'id', 'placeholder' => 'Feedback'],
        'feedback_id_sequence' => ['name' => 'Feedback #', 'type' => 'bigserial', 'placeholder' => 'Sequence', 'format' => 'id'],
        'feedback_stars' => ['name' => 'Feedback Stars', 'type' => 'smallint', 'default' => null, 'null' => true, 'format' => 'id', 'placeholder' => 'Stars'],
        'feedback_note' => ['name' => 'Feedback Note', 'type' => 'varchar', 'length' => 2000, 'placeholder' => 'Note'],
        // AI
        'prompt' => ['name' => 'Prompt', 'type' => 'text', 'placeholder' => 'Prompt'],
        'model_parameters_json' => ['name' => 'Model Parameters (JSON)', 'type' => 'json', 'default' => null, 'null' => true],
        'model_variables_json' => ['name' => 'Model Variables (JSON)', 'type' => 'json', 'default' => null, 'null' => true],
        'agent_instructions' => ['name' => 'Instructions (Agent)', 'type' => 'text', 'placeholder' => 'Instructions'],
        'usage_json' => ['name' => 'Usage (JSON)', 'type' => 'json', 'default' => null, 'null' => true],
        'metadata_json' => ['name' => 'Meta Data (JSON)', 'type' => 'json', 'default' => null, 'null' => true],
        'tool_calls_json' => ['name' => 'Tool Calls (JSON)', 'type' => 'json', 'default' => null, 'null' => true],
    ];
