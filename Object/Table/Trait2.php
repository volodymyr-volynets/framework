...
trait Trait2 {
	 ...
	 */
	public static function getByColumnStatic(string $column, $value, string $only_column = null) {
		$class = get_called_class();
		$object = new $class();
	 ...
	 * @return mixed
	 */
	public function getByColumn(string $column, $value, string $only_column = null) : mixed {
		$result = $this->get([
			'where' => [
				$column => $value
			],
