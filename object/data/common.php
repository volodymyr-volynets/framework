	...
	public static function process_domains($columns, $types = null) {
		...
		foreach ($columns as $k => $v) {
			if (isset($v['domain'])) {
				...
				foreach (['type', 'default', 'length', 'null', 'precision', 'scale', 'format', 'format_params', 'align', 'validator_method', 'validator_params', 'placeholder', 'searchable', 'tree'] as $v2) {
			...
			if (isset($columns[$k]['type']) && isset(self::$types[$columns[$k]['type']])) {
				foreach (['default', 'php_type', 'format', 'format_params', 'align', 'validator_method', 'validator_params', 'placeholder', 'searchable', 'tree'] as $v2) {
